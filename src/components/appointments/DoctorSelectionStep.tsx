            ...
            <CardHeader className="pb-4">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="text-primary font-medium">{dentist.speciality || "General Dentistry"}</CardDescription>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-sm text-muted-foreground">({dentist.appointmentCount} appointments)</span>
                  </div>
                </div>
              </div>
            </CardHeader>
